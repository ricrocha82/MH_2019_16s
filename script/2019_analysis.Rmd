...
# 16S
# load("pseq.bac.RData")
load("pseq.bac.filt.RData") # filtered data
# load("pseq.bac.clr.RData") # clr transformed data
...
```{r clean R env}
rm(list = setdiff(ls(), c('folder_path','color_distance','color_depth','cage_control','pseq.bac','meta', 'env.var',"nuts", "pseq.fun")))
source('~/R/git_hub/MH_2019/script/my_functions.R')
source('~/R/git_hub/MH_2019/script/theme_publication.R')
```
...
```{r clean env}
rm(list = setdiff(ls(), c('folder_path','color_distance','color_depth','cage_control','pseq.bac',"meta", "pseq.fun")))
source('~/R/git_hub/MH_2019/script/my_functions.R')
source('~/R/git_hub/MH_2019/script/theme_publication.R')
```
...
# get meta data
# meta <- pseq.bac %>% get_tibble("sam_data", column_id = "sample_id") %>%
...
pseq.bac %>% tax_table() %>% 
  ...
  add_column(Community = names(pseq.bac))
...
ggsave(paste0(folder_path, "plots/community/pca.16s.tiff"),clr.pca.16s, compression = "lzw")
